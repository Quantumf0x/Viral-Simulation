...
SOURCE_FILES = ChartJS_handler.cpp html_canvas.cpp main.cpp simulation.cpp subject.cpp MovementStrategy.cpp LockdownMovementStrategy.cpp RegularMovementStrategy.cpp
